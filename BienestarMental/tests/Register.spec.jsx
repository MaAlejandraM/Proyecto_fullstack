...
describe('Componente Register', () => {
  ...
  it('muestra error si faltan campos al enviar', async () => {
    ...
    // En vez de hacer click en el botón (la validación nativa del formulario puede impedir
    // que onSubmit se dispare en JS-DOM), enviamos el evento submit directamente al form
